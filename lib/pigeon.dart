  ...
  static void setup(FlutterBeaconApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          ...
          final BeaconData? arg_beaconData = (args[0] as BeaconData?);
          assert(arg_beaconData != null,
              'Argument for dev.flutter.pigeon.beacon_plugin.FlutterBeaconApi.onScanned was null, expected non-null BeaconData.');
          api.onScanned(arg_beaconData!);
          return;
        });
      }
    }
